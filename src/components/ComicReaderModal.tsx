...
export const ComicReaderModal: React.FC<ComicReaderModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-ink/80 backdrop-blur-xs flex items-center justify-center p-2 sm:p-4 animate-in fade-in duration-200">
      <div
        className="bg-stone dark:bg-graphite rounded-panel border border-graphite/20 dark:border-white/15 shadow-xl max-w-5xl w-full h-[90vh] flex flex-col overflow-hidden"
        role="dialog"
        aria-modal="true"
        aria-labelledby="comic-reader-title"
      >
        {/* Header toolbar */}
        <header className="p-3 border-b border-graphite/20 dark:border-white/15 flex flex-wrap items-center justify-between gap-2 bg-stone dark:bg-graphite shrink-0">
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            <button
              ...
              className="p-1.5 rounded-panel text-graphite dark:text-stone hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-signal"
            >
              <List size={18} />
            </button>
        ...
        <div className="flex-1 flex overflow-hidden relative bg-gray-900/90 dark:bg-ink">
          ...
          {showPageDrawer && (
            <aside className="w-64 bg-stone dark:bg-graphite border-r border-graphite/20 dark:border-white/15 p-3 overflow-y-auto space-y-2 z-10 shrink-0 text-xs">
        ...
        <footer className="p-3 border-t border-graphite/20 dark:border-white/15 bg-stone dark:bg-graphite flex items-center justify-between gap-2 shrink-0">
          <div className="flex items-center gap-1">
            <button
              ...
              title="First Page"
              className="p-1.5 rounded-panel border border-graphite/20 dark:border-white/15 bg-stone dark:bg-graphite text-graphite dark:text-stone disabled:opacity-40 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-signal"
            >
            ...
            <button
              ...
              title="Previous Page"
              className="inline-flex items-center gap-1 px-3 py-1.5 text-xs font-medium rounded-panel border border-graphite/20 dark:border-white/15 bg-stone dark:bg-graphite text-graphite dark:text-stone disabled:opacity-40 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-signal"
            >
              <ChevronLeft size={16} />
          ...
          <div className="text-xs font-mono text-graphite dark:text-stone flex items-center gap-2">
            ...
            <select
              ...
              className="bg-stone dark:bg-ink text-graphite dark:text-stone text-xs font-mono border border-graphite/20 dark:border-white/15 rounded px-1.5 py-0.5 focus:outline-none focus-visible:ring-2 focus-visible:ring-signal"
            >
              {comicInfo.pages.map((p, idx) => (
